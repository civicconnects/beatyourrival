...
import '../../models/user_model.dart'; // FIX: Use user_model.dart
...
class _SearchScreenState extends ConsumerState<SearchScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Search & Challenge'),
        centerTitle: true,
      ),
  ...
  // FIX: Changed UserProfile type to UserModel
